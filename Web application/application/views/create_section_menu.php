...
<br/>
<a id="lingid" href="<?php base_url() ?>/index.php/kitchen_menu">Tagasi menüüde lehele</a><br/><br/>
...
if(!empty($menu)){
    ...
    echo '<form onsubmit="return addAllCount(\''.$this->lang->line("order_notification").'\', \''.$this->lang->line("order_notification2").'\');" method="post" accept-charset="utf-8" action="/index.php/section_menu/save_menu/'.$date.'"><table class="section_menu_view">';
